...
import { CategoryImportService } from './core/category-import/category-import.service';
...
async function bootstrap() {
  ...
  const categoryImportService = app.get(CategoryImportService);
  await categoryImportService.import();
