const mockUserId = '48677635-ac6a-4412-8f68-5a933a166a29';
const mockGetCartData = {
  productItems: [
    {
...
const mockToUserId = { userId: '07P1He8a0Ze4OlTCpWf3F3M469H1' };
const mockFromUserId = { fromUserId: '07P1He8a0Ze4OlTCpWf3D3M469P2' };

const mockCartChangeData: any = {
  productItems: [
    {
      itemId: '4549509524765',
      receivingMethod: '1',
      productId: '4549509524318',
      quantity: 5,
    },
  ...
  cartStoreInfo: {
    ...
    branchNumber: '',
    storeName: 'カインズ本庄早稲田',
    storeNameKatakana: 'サイタマ',
    postalCode: '3670030',
    address: '埼玉県本庄市早稲田の杜二丁目１番１号',
    addressKatakana:
      'サイタマケンホンジョウシワセダノモリニチョウメ１バン１ゴウ',
    phone: '04811100000',
    storeClass: '3',
  },
};

const mockCartChangeValidationData: any = {
  productItems: [
    {
      itemId: '4549509524765',
      receivingMethod: '1',
...
const mockValidationCartChangeData: any = {
  productItems: [
    {
      itemId: '4549509524318',
      quantity: 21,
      receivingMethod: '店舗取り置',
    },
  ],
  cartStoreInfo: {
    storeCode: '0816',
...
export {
  mockGetCartData,
  mockAnonymousUserdata,
  mockMembersData,
  mockToUserId,
  mockFromUserId,
  mockCartChangeData,
  mockCartChangeValidationData,
